...
const getMyProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { userId } = user;
    try {
        const user = yield database_config_1.default.captains.findUnique({
            where: { id: userId },
            select: {
                id: true,
                fullName: true,
...
const changePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield database_config_1.default.captains.update({ where: { id: userId }, data: { password: newPassword } });
...
const updateMyProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { userId } = user;
    try {
        const user = yield database_config_1.default.captains.update({ where: { id: userId }, data });
